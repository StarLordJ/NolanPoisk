...
export class ApiController {
    ...
    @httpPost("/api/review", httpReturn.Void, httpBodyParam("name", httpType.String), httpBodyParam("text", httpType.String))
    public async setReview(movie: string, text: string): Promise<void> {
        console.log(movie);
        console.log(text);
    }
}
